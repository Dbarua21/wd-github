    ...
    return (
      <div id="wd-lab1">
        ...
        <div id="wd-lists">
          ...
          <ol id="wd-matcha">
            <li>Sift 1 teaspoon of matcha powder into a small bowl.</li>
            <li>Add 2 tablespoons of hot (but not boiling) water.</li>
            <li>Whisk using a bamboo whisk or frother until smooth and frothy.</li>
            <li>Add a drizzle of honey for sweetness.</li>
            <li>Warm up 3/4 cup of oat milk.</li>
            <li>Pour the oat milk into the matcha mixture.</li>
            <li>Stir gently or froth again for extra foam.</li>
            <li>Enjoy your matcha latte!</li>
          </ol>
          ...
          <ul id="wd-your-books">
            ...
            <li>The Phone Booth at the Edge of the World</li>
            <li>Atomic Habits</li>
          </ul>
        </div>
        ...
        <div id="wd-tables">
          ...
          <table border={1} width="100%">
            ...
            <tbody>
              ...
              <tr><td>Q6</td><td>Express</td><td>3/10/21</td><td>94</td></tr>
              <tr><td>Q7</td><td>MongoDB</td><td>3/17/21</td><td>89</td></tr>
              <tr><td>Q8</td><td>Git</td><td>3/24/21</td><td>90</td></tr>
              <tr><td>Q9</td><td>TypeScript</td><td>3/31/21</td><td>91</td></tr>
              <tr><td>Q10</td><td>APIs</td><td>4/7/21</td><td>93</td></tr>
            </tbody>
            <tfoot>
              <tr><td colSpan={3}>Average</td><td>90.7</td></tr>
            </tfoot>
          </table>
        </div>
        ...
        <div id="wd-forms">
          ...
          <form id="wd-text-fields">
            ...
            <input type="text" placeholder="Doe" value="Wonderland" title="The last name" id="wd-text-fields-last-name" /><br />
        ...
        Visit my GitHub repo <a href="https://github.com/Dbarua21/wd-github" id="wd-github">here</a>
      </div>
    );
  }
